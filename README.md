...
- **Has No Ruby translation** https://www.codewars.com/kata/path-finder-number-2-shortest-path/javascript (`JS solved 20190708`)
- **Has No Ruby translation** https://www.codewars.com/kata/path-finder-number-1-can-you-reach-the-exit/javascript (`JS solved 20190708`)
...
- **4kyu** https://www.codewars.com/kata/shortest-knight-path/ruby (`JS, Ruby, solved/translated 20190708`)
- **Has No Ruby translation**  https://www.codewars.com/kata/path-finder-number-2-shortest-path/javascript (`JS solved 20190708`)
- **Has No Ruby translation** https://www.codewars.com/kata/5765870e190b1472ec0022a2 (`JS solved 20190708`)
